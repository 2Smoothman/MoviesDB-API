...
public class ActorController {
    ...
    public ResponseEntity<?> createActor(@Valid @RequestBody Actor actor) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(createdActor); // Specifying the http status to fit the
                                                                             // task requirements
    }
    ...
    public ResponseEntity<?> getAllActors(
        ...
        // Fetch the actors using a service method and construct the response manually
        // so it looks better
